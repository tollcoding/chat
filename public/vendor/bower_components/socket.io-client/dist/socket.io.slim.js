(function webpackUniversalModuleDefinition (root, factory) {
  if (typeof exports === 'object' && typeof module === 'object') { module.exports = factory(require('JSON')) } else if (typeof define === 'function' && define.amd) { define(['JSON'], factory) } else if (typeof exports === 'object') { exports['io'] = factory(require('JSON')) } else		{ root['io'] = factory(root['JSON']) }
...
/* 0 */
  /***/ function (module, exports, __webpack_require__) {
    ...
    function lookup (uri, opts) {
	  ...
	  } else if (opts && _typeof(opts.query) === 'object') {
...
/* 10 */
  /***/ function (module, exports, __webpack_require__) {
    ...
    function Manager (uri, opts) {
	  ...
	  if (uri && (typeof uri === 'undefined' ? 'undefined' : _typeof(uri)) === 'object') {
	    opts = uri
	    uri = undefined
	  }
	  opts = opts || {}
...
/* 13 */
  /***/ function (module, exports, __webpack_require__) {
	 ...
	 */
	  ...
	  this.secure = opts.secure != null ? opts.secure
...
/* 17 */
  /***/ function (module, exports, __webpack_require__) {
	 ...
	 */
	  ...
	  return typeof global.XDomainRequest !== 'undefined' && !this.xs && this.enablesXDR
      }
...
/* 18 */
  /***/ function (module, exports, __webpack_require__) {
    ...
    Polling.prototype.uri = function () {
	  ...
	  if (this.port && ((schema === 'https' && Number(this.port) !== 443) ||
	     (schema === 'http' && Number(this.port) !== 80))) {
	    port = ':' + this.port
	  }
...
/* 34 */
  /***/ function (module, exports, __webpack_require__) {
	      ...
	      parser.encodePacket(packet, self.supportsBinary, function (data) {
	        if (!self.usingBrowserWebSocket) {
	          ...
	          if (self.perMessageDeflate) {
	            var len = typeof data === 'string' ? global.Buffer.byteLength(data) : data.length
	 ...
	 */
	  ...
	  // avoid port if default for schema
	  if (this.port && ((schema === 'wss' && Number(this.port) !== 443) ||
	    (schema === 'ws' && Number(this.port) !== 80))) {
	    port = ':' + this.port
	  }
